package com.example.root.libapp_v1.Phoenix;
...
import com.example.root.libapp_v1.Phoenix.refresh_view.BaseRefreshView;
import com.example.root.libapp_v1.Phoenix.refresh_view.SunRefreshView;
import com.example.root.libapp_v1.Phoenix.util.Utils;
...
public class PullToRefreshView extends ViewGroup {
    ...
    public PullToRefreshView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, com.example.root.libapp_v1.R.styleable.RefreshView);
        final int type = a.getInteger(com.example.root.libapp_v1.R.styleable.RefreshView_type, STYLE_SUN);
        a.recycle();
