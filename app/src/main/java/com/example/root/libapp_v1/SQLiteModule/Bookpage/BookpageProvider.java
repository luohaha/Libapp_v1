 ...
 */
public class BookpageProvider extends ContentProvider{
    private String mTableName = "bookpage";
    private final String TAG = "bookpage";
    ...
    static {
         ...
         * */
        URI_MATCHER.addURI("com.example.root.libapp_v1.SQLiteModule.Bookpage.BookpageProvider",
                "bookpage", ALL_ID);
        /**
    ...
    public String getType(Uri uri) {
        ...
        switch (flag) {
            case ONE_ID :
                type = "vnd.android.cursor.item/bookpage";
                Log.i(TAG, "----->>getType return item");
                break;
            case ALL_ID :
                type = "vnd.android.cursor.dir/bookpages";
