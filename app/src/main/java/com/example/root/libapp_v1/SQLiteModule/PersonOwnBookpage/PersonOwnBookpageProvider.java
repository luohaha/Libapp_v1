 ...
 */
public class PersonOwnBookpageProvider extends ContentProvider {
    private String mTableName = "personownbookpage";
    private final String TAG = "personownbookbookpage";
    ...
    static {
         ...
         * */
        URI_MATCHER.addURI("com.example.root.libapp_v1.SQLiteModule.PersonOwnBookpage.PersonOwnBookpageProvider",
                "personownbookpage", ALL_ID);
        /**
         * want to use the record which id equal to #, and then return 2
         * */
        URI_MATCHER.addURI("com.example.root.libapp_v1.SQLiteModule.PersonOwnBookpage.PersonOwnBookpageProvider",
                "personownbookpage/#", ONE_ID);
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (flag) {
            case ONE_ID :
                type = "vnd.android.cursor.item/personownbookpage";
                Log.i(TAG, "----->>getType return item");
                break;
            case ALL_ID :
                type = "vnd.android.cursor.dir/personownbookpages";
