package com.example.root.libapp_v1.SQLiteModule.PersonCommentpage;
...
/**
 * Created by Yixin on 15-5-5.
 */
public class PersonCommentpageProvider extends ContentProvider{
    private String mTableName = "personcommentpage";
    private final String TAG = "personcommentpage";
    ...
    static {
        /**
         * want to use all record in table bookpage
         * if it match, and then return 1
         * */
        URI_MATCHER.addURI("com.example.root.libapp_v1.SQLiteModule.PersonCommentpage.PersonCommentpageProvider",
                "personcommentpage", ALL_ID);
        /**
         * want to use the record which id equal to #, and then return 2
         * */
        URI_MATCHER.addURI("com.example.root.libapp_v1.SQLiteModule.PersonCommentpage.PersonCommentpageProvider",
                "personcommentpage/#", ONE_ID);
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (flag) {
            case ONE_ID :
                type = "vnd.android.cursor.item/personcommentpage";
                Log.i(TAG, "----->>getType return item");
                break;
            case ALL_ID :
                type = "vnd.android.cursor.dir/personcommentpages";
